...
const crestStyles: React.CSSProperties[] = [
  ...
  { fontFamily: "'Courier New', monospace", fontWeight: 900, letterSpacing: "-0.06em" },
  { fontFamily: "Impact, Haettenschweiler, sans-serif", letterSpacing: "-0.045em" },
]
...
export function CoinCrestWordmark({
  ...
  return (
    ...
    >
      <span>COIN</span>
      <span
        className="ml-[0.03em] inline-block text-[#D90000] transition-all duration-700"
